-- ============================================
-- STOKVA — Migration 003 : déduplication articles G0
-- ============================================
-- Si un même article apparaît sur plusieurs lignes d'un BR/BL,
-- il était listé plusieurs fois dans v_register_g0.article_name.
-- Correction : DISTINCT dans le string_agg.
-- ============================================
